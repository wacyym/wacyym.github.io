 ...
 ***********************************************************************/
function __font() { 
__font_init__(this, font, 'Times', 18, 1, 0)}; var font = new __font();
...
__instance_init__(this, obj_controller, null, 1, 0, null, 0, 16);
this.on_creation = function() {
with(this) {
draw_set_font(font);
doc = document.getElementById("tululoogame");
...
this.start = function() {
__room_start__(this, scene_24, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
var scene_24 = new __scene_24();
tu_scenes.push(scene_24);
